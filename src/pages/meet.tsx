...
function Vision() {
  return (
    <Layout>
      ...
      style={{
        backgroundImage: 'url(https://www.utk.edu/images/i/warmers/repeatingpattern_white_1.jpg)'
      }}
      >
        <div className="container">
          <div className="row  align-items-center mt-5">
      ...
      <div className="container-fluid bg-smokey text-center py-5 bg-img-cta   row no-gutters align-items-center"
      style={{
        backgroundImage: 'url(https://www.utk.edu/images/i/warmers/experiencecampus_1.svg)'
      }}
      >
        <div className="col-12 col-md-6 mx-auto">
          <svg
      ...
      <div className="container-fluid bg-light pb-4 py-md-5 no-gutters"
      style={{
        backgroundImage: 'url(https://www.utk.edu/images/i/warmers/texture_2.jpg)'
      }}
      >
        <div className="container">
          <div className="row  align-items-center mt-5">
      ...
      style={{
        backgroundImage: 'url(https://www.utk.edu/images/i/warmers/pedwalkway_1.jpg)'
      }}
      >
      ...
      <div className="container-fluid bg-smokey text-center py-5 bg-img-cta   row no-gutters align-items-center"
      style={{
        backgroundImage: 'url(https://www.utk.edu/images/i/warmers/texture_rowing.jpg)'
      }}
      >
        <div className="col-12 col-md-6 mx-auto">
      ...
      <div className="container-fluid bg-orange  pt-lg-1 pb-5">
        ...
        style={{
          backgroundImage: 'url(https://www.utk.edu/images/i/warmers/2021-community_service.jpg)'
        }}
        >
          <div className="row align-items-end">
        ...
        style={{
          backgroundImage: 'url(https://www.utk.edu/images/i/warmers/studentsoncampus_1.jpg)'
        }}
        >
        </div>
      ...
      <div className="container-fluid bg-smokey text-center py-5 bg-img-cta   row no-gutters align-items-center"
      style={{
        backgroundImage: 'url(https://www.utk.edu/images/i/warmers/2021-becomeavol_1.svg)'
      }}
      >
        <div className="col-12 col-md-6 mx-auto">
          <svg version="1.1" className="icon-tn" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 103 25"  xmlSpace="preserve">
      ...
      <div className="container-fluid bg-orange  py-3 py-md-5">
        ...
        style={{
          backgroundImage: 'url(https://www.utk.edu/images/i/warmers/2021-smokey_photoop2.jpg)'
        }}
        >
          <div className="row align-items-end">
      ...
      style={{
        backgroundImage: 'url(https://www.utk.edu/images/i/warmers/mae_confirmation_1.jpg)'
      }}
      >
          <div className="row align-items-end align-items-md-center module">
            <div className="col-12 col-md-10 mx-auto ml-lg-4 col-lg-5 bg-white mb-lg-5 offset-lg-0 pt-5 p-2 p-md-5">
      ...
      <div className="container-fluid bg-smokey text-center py-5 bg-img-cta   row no-gutters align-items-center"
      style={{
        backgroundImage: 'url(https://www.utk.edu/images/i/warmers/repeatingpattern_gray_1.jpg)'
      }}
       >
        <div className="col-12 col-md-6 mx-auto">
          <svg version="1.1" className="icon-tn" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 103 25" xmlSpace="preserve">
