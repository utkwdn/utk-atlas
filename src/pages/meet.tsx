  ...
  return (
    <Layout>
      ...
      <div className="position-sticky">
        <ul
          id="list-navigation"
          className="nav nav-pills justify-content-center position-sticky"
        >
          ...
          <li className="nav-item">
            <a className="nav-link" href="#afford">
              Afford
            </a>
          </li>
          <li className="nav-item">
            <a className="nav-link" href="#traditions">
              Traditions
            </a>
          </li>
        </ul>
      ...
      <div id="experience">
          ...
          >
            <div className="row align-items-end">
              ...
              >
                ...
                <p className="mb-0">
                  The moment you set foot on Rocky Top (our affectionate name
                  for campus), you&lsquo;ll find a place that feels like home.
                  Our 910-acre campus is filled with energy and tradition. This
                  is a place where you can learn and grow with the support of a
                  Volunteer family.
                </p>
              </div>
            </div>
        ...
        >
          <div className={[styles.meeth2, 'col-12 col-md-6 mx-auto'].join(' ')}>
            ...
            <h2 className="text-white mt-5 text-uppercase">
              Want to learn more?
            </h2>
            <p className="text-white mb-5">...and get a free sticker!</p>
            <button
              type="button"
              className="btn btn-light btn-chevron mb-5 text-uppercase"
              data-toggle="modal"
                ...
                <div className={styles.framed}>
                  <div className="embed-responsive embed-responsive-16by9 mb-md-0">
                    <iframe
                      ...
                      src="https://www.youtube.com/embed/QAS8yNqJj9M"
              ...
              <div className="row no-gutters">
                <div className="col-12 col-md-10 offset-md-1  mt-md-n5">
                  <picture className=" ">
                    <source
                      ...
                      srcSet="//images.utk.edu/designsystem/meet/girlengineer_xl.jpg"
                    />
                    <source
                      media="(min-width: 992px)"
                      srcSet="//images.utk.edu/designsystem/meet/girlengineer_lg.jpg"
                    />
                    <source
                      media="(min-width: 768px)"
                      srcSet="//images.utk.edu/designsystem/meet/girlengineer_md.jpg"
                    />
                    <source
                      media="(min-width: 600px)"
                      srcSet="//images.utk.edu/designsystem/meet/girlengineer_sm.jpg"
                    />
                    <source
                      media="(min-width: 576px)"
                      srcSet="//images.utk.edu/designsystem/meet/girlengineer_xs.jpg"
                    />
                ...
                <div className="col-12 col-md-4 col-lg-5 offset-md-1">
                  <picture className=" ">
                    <source
                      ...
                      srcSet="//images.utk.edu/designsystem/meet/2021-Lab_900x1100.jpg"
                    />
                    <source
                      media="(min-width: 992px)"
                      srcSet="//images.utk.edu/designsystem/meet/2021-Lab_900x1100.jpg"
                    ...
                    <source
                      media="(min-width: 768px)"
                      srcSet="//images.utk.edu/designsystem/meet/sciencesat_300x750.jpg"
                    />
                    <source
                      media="(min-width: 576px)"
                      srcSet="//images.utk.edu/designsystem/meet/sciencesat_300x75dd0.jpg"
                    />
                    <source srcSet="//images.utk.edu/designsystem/meet/2021-Lab_900x800.jpg" />
                    <img
                      src="//images.utk.edu/designsystem/meet/2021-Lab_900x800.jpg"
                      alt=""
                    />
                  </picture>
                </div>
                  ...
                  >
                    ...
                    <p>
                      ...
                      <a
                        ...
                        rel="noreferrer"
                      >
                        360+ undergraduate degree options
                      </a>
                      , honors programs, and an emphasis on research and
                      service-learning, UT will prepare you for what comes after
                      college. We may look like a large university, but our
                      caring faculty and staff will make your time here personal
                      and welcoming.
                    </p>
                  </div>
                </div>
                <div className="col-12 col-md-10 offset-md-1">
                  <picture className=" ">
                    <source
                      media="(min-width: 1400px)"
                      srcSet="//images.utk.edu/designsystem/meet/sciencesat_1200x600.jpg"
                    />
                    <source
                    ...
                    <source
                      media="(min-width: 768px)"
                      srcSet="//images.utk.edu/designsystem/meet/2021-Lab_1200x600.jpg"
                    />
                    <source srcSet="//images.utk.edu/designsystem/meet/sciencesat_xs.jpg" />
                    <img
                      src="//images.utk.edu/designsystem/meet/sciencesat_xl.jpg"
                      alt=""
                    />
                  </picture>
                </div>
          ...
          <div>
                    ...
                    >
                      ...
                      <p>
                        ...
                        <a
                          ...
                          rel="noreferrer"
                        >
                          engage in research and creative endeavors
                        </a>
                        , pursing career opportunites, and discovering answers
                        to challenging questions.
                      </p>
                      <p>
                        Our region is home to major businesses and innovators
                        that partner with the university and offer internships
                        and careers, including Oak Ridge National Laboratory,
                        the US Department of Energy&apos;s largest science and
                        energy laboratory.
                      </p>
                    </div>
                  </div>
            ...
            >
              ...
              >
                ...
                <h2 className="text-white my-5 text-uppercase">
                  We Can&rsquo;t Wait To Show You Around Rocky Top
                </h2>
                <a
                  className="btn btn-light btn-chevron mb-5 text-uppercase"
                  href="https://admissions.utk.edu/visit/?utm_source=meet-landing-page-2021&utm_medium=website&utm_campaign=meet-ut-2021&utm_id=0&utm_content=visit"
                  target="_blank"
                  rel="noreferrer"
                >
                  Visit Campus
            ...
            <div className="container-fluid bg-light bg-img-fixed p-0 no-gutters module-50 bg-aerial"></div>
              ...
              <div className="container">
                <div className="row no-gutters">
                  <div className="col-12 col-lg-10 offset-lg-1 mt-md-n5">
                    <img
                      className=" "
                      src="//images.utk.edu/designsystem/meet/knox_skyline.jpg"
                      width="1800"
                      height="600"
                  ...
                  <div className="row no-gutters">
                    ...
                    >
                      <div className="p-3 p-md-5">
                        ...
                        <p>
                          ...
                          , mountains, rivers, and trails come together to
                          connect the urban and the wild. Close to campus is
                          downtown Knoxville with shops. restaurants, theaters,
                          and more. Nearby is Knoxville&apos;s renowned Urban
                          Wilderness, and the Great Smoky Mountains National
                          Park, with 800+ miles of trails, is just down the
                          road.
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="row no-gutters">
                        <div className="col-6 col-md-12">
                          <picture className=" ">
                            <source
                              media="(min-width: 1200px)"
                              srcSet="//images.utk.edu/designsystem/meet/wakeboard_lg-1.jpg"
                            />
                            <source
                              media="(min-width: 992px)"
                              srcSet="//images.utk.edu/designsystem/meet/wakeboard_md.jpg"
                            />
                            <source
                              media="(min-width: 768px)"
                              srcSet="//images.utk.edu/designsystem/meet/wakeboard_sm.jpg"
                            />
                            <source srcSet="//images.utk.edu/designsystem/meet/wakeboard_xs.jpg" />
                            <img
                              src="//images.utk.edu/designsystem/meet/wakeboard_xs.jpg"
                              width="600"
                              height="900"
                              alt="Wake Board"
                            />
                        ...
                        <div className="col-6 col-md-12">
                          <picture className=" ">
                            <source
                              media="(min-width: 1200px)"
                              srcSet="//images.utk.edu/designsystem/meet/bike_lg-1.jpg"
                            />
                            <source
                              media="(min-width: 992px)"
                              srcSet="//images.utk.edu/designsystem/meet/bike_md.jpg"
                            />
                            <source
                              media="(min-width: 768px)"
                              srcSet="//images.utk.edu/designsystem/meet/bike_sm.jpg"
                            />
                            <source srcSet="//images.utk.edu/designsystem/meet/bike_xs.jpg" />
                            <img
                              src="//images.utk.edu/designsystem/meet/bike_xl.jpg"
                              width="600"
                              height="900"
                              alt="Mountain biking."
                            />
                    ...
                    <div className="row no-gutters order-md-3">
                      <div className="col-5  col-lg-4 offset-lg-1">
                        <img
                          className=" "
                          src="//images.utk.edu/designsystem/meet/2021-marketsquare.jpg"
                          width="1200"
                          height="1000"
                          alt="Market Square"
                        />
                      ...
                      <div className="col-7  col-lg-6 offset-lg-0 order-4">
                        <picture className=" ">
                          <source
                            media="(min-width: 992px)"
                            srcSet="//images.utk.edu/designsystem/meet/2021-smokies.jpg"
                          />
                          <source srcSet="//images.utk.edu/designsystem/meet/2021-marketsquare_xs.jpg" />
                          <img
                            src="//images.utk.edu/designsystem/meet/2021-smokies.jpg"
                            width="600"
                            height="900"
                            alt="The Smokies."
                          />
          ...
          <div id="afford">
                  ...
                  <div className="col-12 col-md-7 col-lg-6 col-xl-5 offset-xl-1">
                    ...
                    >
                      ...
                      <p>
                        ...
                        to a variety of scholarships. And we work with you to
                        prepare for whatever may come next. More than 80 percent
                        of our graduates are employed or in graduate school
                        within six months of finishing their degree, and all our
                        graduates join a global network of more than 260,000
                        alumni ready to help open doors for fellow Vols.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            >
              ...
              >
                ...
                <h2 className="text-white  my-5 text-uppercase">
                  Find out what makes UT such a good investment
                </h2>
                <a
                  className="btn btn-light btn-chevron mb-5  text-uppercase"
                  href="https://admissions.utk.edu/afford/?utm_source=meet-landing-page-2021&utm_medium=website&utm_campaign=meet-ut-2021&utm_id=0&utm_content=value"
                  target="_blank"
                  rel="noreferrer"
                >
          ...
          <div id="apply">
              ...
              >
                <div className="row align-items-end">
                  ...
                  >
                    ...
                    <p>
                      We live the Volunteer spirit, stepping forward in service
                      and leadership, through our classes and countless
                      opportunities for community involvement. We bear the torch
            ...
            >
              ...
              >
                ...
                <a
                  className="btn btn-light btn-chevron mb-5 text-uppercase"
                  href="https://admissions.utk.edu/apply/?utm_source=meet-landing-page-2021&utm_medium=website&utm_campaign=meet-ut-2021&utm_id=0&utm_content=apply"
                  target="_blank"
                  rel="noreferrer"
                >
                  Learn How to Apply
          ...
          <div id="traditions">
              ...
              >
                <div className="row align-items-end">
                  ...
                  >
                    ...
                    <p>
                      We sing &ldquo;Rocky Top&rdquo; loudly and often, and
                      everyone wants to pet our campus celebrity&mdash;a
                      bluetick coonhound named Smokey. Outside the classroom,
                      you&lsquo;ll have plenty of opportunities to make friends
                      and memories through on-campus events and more than 400
            ...
            >
              ...
              >
                ...
                <h2 className="text-white mt-5 text-uppercase">
                  That&lsquo;s a little about us. We can&lsquo;t wait to meet
                  you!
                </h2>
                <p className="text-white mb-5">
                  Tell us about you and get a free sticker!
                </p>
                <button
                  type="button"
                  className="btn btn-light btn-chevron mb-5 text-uppercase"
