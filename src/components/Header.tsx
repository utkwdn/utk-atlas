  ...
  return (
    ...
    <nav id="universal-header">
        ...
        <ul className="row justify-content-end list-inline mb-0">
          <li className="col-auto"><small><a href="/requestinfo/" className="nav-link px-0 text-light text-uppercase">Request Info</a></small></li>
          <li className="col-auto"><small><a href="/visit/" className="nav-link px-0 text-light text-uppercase">Visit</a></small></li>
          <li className="col-auto"><small><a href="/apply/" className="nav-link px-0 text-light text-uppercase">Apply</a></small></li>
          <li className="col-auto"><small><a href="/give/" className="nav-link px-0 text-light text-uppercase">Give</a></small></li>
              ...
              <div className="modal-content">
                ...
                <nav id="universal-header">
                  <div className="container">
                    <ul className="row justify-content-end list-inline mb-0">
                      <li className="col-auto"><small><a href="/requestinfo/" className="nav-link px-0 text-light text-uppercase text-small text-white btn-request">Request Info</a></small></li>
                      <li className="col-auto"><small><a href="/visit/" className="nav-link px-0 text-light text-uppercase">Visit</a></small></li>
                      <li className="col-auto"><small><a href="/apply/" className="nav-link px-0 text-light text-uppercase">Apply</a></small></li>
                      <li className="col-auto"><small><a href="/give/" className="nav-link px-0 text-light text-uppercase">Give</a></small></li>
                      <li className="col-auto">
                        <button type="button" className="btn btn-search text-uppercase text-light navbar-toggler col-auto collapsed" id="btn-searchclose" data-bs-toggle="modal" data-bs-target="#searchModal" aria-label="Toggle search">
                  ...
                  <div className="container-xxl">
                    <div className="row justify-content-center">
                      <div className="col-12 col-md-10 col-lg-6">
                        <h1 className="text-center mt-md-5 mb-2 mb-md-5 fw-lighter">Search</h1>
                      </div>
                    </div>
                    <div className="row justify-content-center">
                      <div className="col-12 col-xl-8">
                        <ul className="nav nav-pills justify-content-center justify-content-lg-start" id="searchTab" role="tablist">
                          <li className="nav-item" role="presentation">
                            <button className="nav-link active" id="this-site-tab" data-bs-toggle="tab" data-bs-target="#this-site" type="button" role="tab" aria-controls="this-site" aria-selected="true">Search utk.edu</button>
                          </li>
                          <li className="nav-item" role="presentation">
                          ...
                          <li className="nav-item" role="presentation">
                            <button className="nav-link" id="news-tab" data-bs-toggle="tab" data-bs-target="#news" type="button" role="tab" aria-controls="news" aria-selected="false">News</button>
                          </li>
                          <li className="nav-item" role="presentation">
                            <button className="nav-link" id="dir-tab" data-bs-toggle="tab" data-bs-target="#dir" type="button" role="tab" aria-controls="dir" aria-selected="false">Directory</button>
                          </li>
                         <li className="nav-item" role="presentation">
                            <a className="nav-link" href="https://www.utk.edu/alpha">A-Z Index</a>
                          </li>
                          <li className="nav-item" role="presentation">
                            <a className="nav-link" href="https://maps.utk.edu">Map</a>
                          </li>
                        </ul>
                        ...
                        <div className="tab-content">
                          <div className="tab-pane active" id="this-site" role="tabpanel" aria-labelledby="this-site-tab">
                            ...
                            <form className="form-inline hidden-print mt-4" id="cse-searchbox-form">
                              <div className="mb-3 input-group">
                                ...
                                </svg> <span className="visually-hidden">Search</span></button>
                              </div>
                            </form>
                          ...
                          <div className="tab-pane" id="dir" role="tabpanel" aria-labelledby="dir-tab">
                  ...
                  <div className="container-fluid universal-footer">
                    <div className="container">
                      <div className="row py-3 pt-md-3 pb-md-0 justify-content-center">
                        ...
                        <div className="col-6 col-md-6 col-lg-4 ms-lg-auto mt-md-n5 p-1 p-md-3 utk-identifier"> <a href="https://www.utk.edu/" className="align-self-center"> Logo SVG here</a> </div>
                      </div>
                    </div>
                  </div>
                </footer>
